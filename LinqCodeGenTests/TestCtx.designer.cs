...
namespace LinqCodeGenTests
{
    ...
    partial void OnversionChanged();
		...
		[Association(Name="ent3__3to3", Storage="__3to3s", ThisKey="id", OtherKey="ent3_id1")]
		...
		[Association(Name="ent3__3to31", Storage="__3to3s1", ThisKey="id", OtherKey="ent3_id2")]
    ...
    partial void Onent3_id2Changed();
		...
		[Column(Storage="_ent3_id1", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int ent3_id1
		{
			get
			{
		...
		[Column(Storage="_ent3_id2", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int ent3_id2
		{
			get
			{
		...
		[Association(Name="ent3__3to3", Storage="_ent3", ThisKey="ent3_id1", OtherKey="id", IsForeignKey=true)]
		public ent3 ent3
		{
			get
			{
		...
		[Association(Name="ent3__3to31", Storage="_ent31", ThisKey="ent3_id2", OtherKey="id", IsForeignKey=true)]
		public ent3 ent31
		{
			get
			{
    ...
    partial void OnnameChanged();
		...
		[Column(Storage="_i", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int i
		{
			get
			{
		...
		[Association(Name="complex_pk_complex_fk", Storage="_complex_fks", ThisKey="code,i", OtherKey="code,i")]
    ...
    partial void OnxChanged();
		...
		[Association(Name="complex_pk_complex_fk", Storage="_complex_pk", ThisKey="code,i", OtherKey="code,i", IsForeignKey=true)]
